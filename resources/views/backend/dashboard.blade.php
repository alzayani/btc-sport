                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body chat-box scrollable" style="height:300px;">
                            <ul class="chat-list">
                                <li class="chat-item">
                                    <div class="chat-img"><img src="{{ asset('assets/img/users/1.jpg')}}" alt="user">
                                    </div>
                                ...
                                <li class="chat-item">
                                    <div class="chat-img"><img src="{{ asset('assets/img/users/2.jpg')}}" alt="user">
                                    </div>
                                    <div class="chat-content">
                                ...
                                <li class="chat-item">
                                    <div class="chat-img"><img src="{{ asset('assets/img/users/3.jpg')}}" alt="user">
                                    </div>
                                    <div class="chat-content">
                    ...
                    <div class="list-item-wrap">
                        <div class="list-item">
                            <div class="item-inner">
                                ...
                                <div class="list-title"><a href="javascript:void(0)">Lorem Ipsum is simply dumm dummy
                                        text of the printing and typesetting industry.</a></div>
                            ...
                            <div class="qickview-wrap">
                                <div class="desc">
                                    <p>Fusce suscipit turpis a dolor posuere ornare at a ante. Quisque nec libero
                                        facilisis, egestas tortor eget, mattis dui. Curabitur viverra laoreet ligula at
                                        hendrerit. Nullam sollicitudin maximus leo, vel pulvinar orci semper id. Donec
                                        vehicula tempus enim a facilisis. Proin dignissim porttitor sem, sed pulvinar
                                        tortor gravida vitae.</p>
                                </div>
                            </div>
                        </div>
                        <div class="list-item">
                ...
                <div class="card-body">
                    <table id="advanced_table" class="table">
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/img/users/1.jpg')}}" class="table-user-thumb" alt=""></td>
                            <td>Tiger Nixon</td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/img/users/2.jpg')}}" class="table-user-thumb" alt=""></td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/img/users/3.jpg')}}" class="table-user-thumb" alt=""></td>
                            <td>Ashton Cox</td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/img/users/4.jpg')}}" class="table-user-thumb" alt=""></td>
                            <td>Cedric Kelly</td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/img/users/5.jpg')}}" class="table-user-thumb" alt=""></td>
                            <td>Airi Satou</td>
                            <td>Accountant</td>
                            <td>Tokyo</td>
                            <td>33</td>
