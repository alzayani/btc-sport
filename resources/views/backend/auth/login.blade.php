...
<head>
    ...
    <title>Login | BTC - Admin Panel</title>
    ...
    <script src="{{ asset('assets/src/js/vendor/modernizr-2.8.3.min.js')}}"></script></head>
...
{{--                <div class="lavalite-bg" style="background-image: {{URL::asset('assets/img/auth/login-bg.jpg')}}">--}}
            ...
            <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                <div class="authentication-form mx-auto">
                    ...
                    <h3>Sign In to BTC Admin Panel</h3>
                    <p>Happy to see you again!</p>
                    <form action="{{route('admin.login.submit')}}" method="POST">
                        @csrf
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Email" name="email" required="" value="admin@admin.com">
                            <i class="ik ik-user"></i>
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="Password" name="password" required="" value="112233">
                            <i class="ik ik-lock"></i>
                        </div>
                        <div class="row">
                            <div class="col text-left">
                                <label class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="item_checkbox" name="remember" value="1">
