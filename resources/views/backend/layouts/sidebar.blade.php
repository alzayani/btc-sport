...
{{--                    <a href="{{route('admin.dashboard')}}"><i class="ik ik-bar-chart-2"></i><span>Dashboard</span></a>--}}
                ...
                <div class="nav-item">
                    <a href="pages/navbar.html"><i class="ik ik-menu"></i><span>Coach</span></a>
                </div>
                <div class="nav-item has-sub">
                    <a href="javascript:void(0)"><i class="ik ik-users"></i><span>Administration</span></a>
                    <div class="submenu-content">
                        <a href="#" class="menu-item">Add Admin</a>
                        <a href="{{route('administration.index')}}" class="menu-item">Admin</a>
                ...
                <div class="nav-item has-sub">
                    ...
                    <div class="submenu-content">
                        <a href="{{route('user.create')}}" class="menu-item">Add User or Member</a>
                        <a href="{{route('member.index')}}" class="menu-item">Members</a>
                        <a href="{{route('user.index')}}" class="menu-item">Users</a>
